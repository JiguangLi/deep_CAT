...
def parse_args(verbose: bool = False) -> typing.Dict[str, typing.Any]:
    ...
    parser.add_argument("--variance_threshold", type=float, default=0.14)
    ...
    parser.add_argument("--reward_type", type=str, default="first0-1")
    parser.add_argument("--gamma", type=float, default=0.95)
    parser.add_argument("--epsilon_start", type=float, default=0.99)
    parser.add_argument("--epsilon_end", type=float, default=0.01)
    parser.add_argument("--epsilon_decrease_steps", type=int, default=600000)
    ...
    parser.add_argument("--max_item_per_learner", type=int, default=50)
    ...
    parser.add_argument("--model_name", type=str, default="online-Q-network-v4-6-factor")
...
if __name__ == "__main__":
    ...
    varaince_threshold = arguments["variance_threshold"]
    _save_path = (
            pathlib.Path(arguments["cat_cog_models_dir"])
            / f"{model_name}"
            / f"NN_{train_data_name[:-8]}_{num_episodes}_{reward_type}_{pred_type}_{network_version}_{learning_rate}_{batch_size}_{buffer_size}_{epsilon_steps}_{varaince_threshold}"
    )
