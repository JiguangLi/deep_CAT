...
def parse_args(verbose: bool = False) -> typing.Dict[str, typing.Any]:
    ...
    parser.add_argument("--variance_threshold", type=float, default=0.36)
    ...
    parser.add_argument("--learner_eval_sample", type=int, default=600)
    ...
    parser.add_argument("--epsilon_decrease_steps", type=int, default=60000)
    ...
    parser.add_argument("--max_item_per_learner", type=int, default=55)
    ...
    parser.add_argument("--model_name", type=str, default="online-Q-network-v4-3factor-mixed")
...
if __name__ == "__main__":
    ...
    _save_path = (
            ...
            / f"{model_name}"
            / f"retrain_{retrain_version}_NN_{train_data_name[:-7]}_{num_episodes}_{reward_type}_{pred_type}_{network_version}_{learning_rate}_{batch_size}_{buffer_size}_{epsilon_steps}"
    )
    ...
    # retrain_params
    retrain_params ={
        "network_folder_dir" : "/home/jiguang0/bayesian-cat/models/q_learning/online-Q-network-v4-3factor-mixed/NN_s017_mixed_grid_500_150_3_2_150000_0-1_detailed_v4_1.3e-05_128_30000_900000_0.13",
        "network_name": "fn_37000.pt",
