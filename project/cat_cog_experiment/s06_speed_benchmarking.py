...
if __name__ == "__main__":
    ...
    theta = np.random.multivariate_normal(np.zeros(6), np.identity(6), 1)
    ...
    filename = "online-Q-network-v4-6-factor/NN_bifactor_alphas_150000_first0-1_detailed_v4_1.5e-05_128_30000_600000_0.14/fn_69000.pt"
