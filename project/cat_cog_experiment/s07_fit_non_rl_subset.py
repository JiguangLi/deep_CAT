...
def parse_args(verbose: bool = False) -> typing.Dict[str, typing.Any]:
    ...
    parser.add_argument("--subset", default=[0], help="subset factors of interest")
...
if __name__ == "__main__":
    ...
    for rule in selection_rules:
        ...
        model.simulate()
        filename = "COG_s07_{}_{}_subset_v2.pickle".format(rule, arguments["max_items"])
        model_output_dir = pathlib.Path(arguments["cat_cog_models_dir"])
