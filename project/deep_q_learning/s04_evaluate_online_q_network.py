...
if __name__ == "__main__":
    ...
    folder_name = "NN_s017_mixed_grid_500_150_3_2_150000_0-1_detailed_v4_1.5e-05_128_30000_800000_0.16"
    network_name = "fn_34000.pt"
    nn_input_dir = pathlib.Path(arguments["q_learning_models_dir"]).joinpath("online-Q-network-v4-3factor-mixed")
    ...
    model.simulate()
    filename = "x05_s04_QCAT_{}_{}_{}_final.pickle".format(arguments["input_data_name"][:-7], folder_name, network_name)
