...
if __name__ == "__main__":
    ...
    _save_path = (
            ...
            / f"{model_name}"
            / f"retrain_{retrain_version}_NN_{train_data_name[:-8]}_{num_episodes}_{reward_type}_{pred_type}_{network_version}_{learning_rate}_{batch_size}_{buffer_size}_{epsilon_steps}"
    )
