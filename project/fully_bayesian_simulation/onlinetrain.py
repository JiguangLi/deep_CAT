...
def online_train_double_dqn(
    ...
    # Set up parameters
    pos_num_samples, m, k = alphas.shape
    ...
    model = bcat.BayesianOnlineQNetworkV4(
        input_dim=input_dim,
        input_stats_dim=input_stats_dim,
        num_items=m,
        hidden_dim_phi1=256,
    ).to(device)
    target_network = bcat.BayesianOnlineQNetworkV4(
        input_dim=input_dim,
        input_stats_dim=input_stats_dim,
        num_items=m,
        hidden_dim_phi1=256,
    ...
    for episode in range(int(num_episodes)):
        ...
        episode_learner = bcat.BayesianOnlineEpisodeLearner(
            point_theta=theta,
            alphas=alphas,
