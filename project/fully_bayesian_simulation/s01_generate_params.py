...
def parse_args(verbose: bool = False) -> typing.Dict[str, typing.Any]:
    ...
    parser.add_argument("--zero_entries", default=[1,2])
...
if __name__ == "__main__":
    ...
    filename = "x10_s01_mixed_grid_{}_{}_{}_{}.pickle".format(n, m, k, max_zero)
    data_output_dir = pathlib.Path(arguments["sim_data_dir"])
    response = bcat.util.probit_mirt_binary_data(sim_params)
    sim_params["response"] = response
