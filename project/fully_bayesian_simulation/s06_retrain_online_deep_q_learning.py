...
def parse_args(verbose: bool = False) -> typing.Dict[str, typing.Any]:
    ...
    parser.add_argument("--retrain_version", type=str, default="v1")
...
if __name__ == "__main__":
    ...
    _save_path = (
            ...
            / f"{model_name}"
            / f"retrain_{retrain_version}_NN_{train_data_name[:-7]}_{num_episodes}_{reward_type}_{variance_threshold}_{learning_rate}_{batch_size}_{buffer_size}_{epsilon_steps}"
    )
    ...
    # retrain_params
    retrain_params ={
        "network_folder_dir" : "/home/jiguang0/bayesian-cat/models/q_learning/online-Q-network-v4/NN_s01_500_500_4_1_100000_0-1_detailed_v4_1e-05_128_20000_80000",
        "network_name": "fn_14000.pt",
