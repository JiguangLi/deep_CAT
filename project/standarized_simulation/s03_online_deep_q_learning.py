...
if __name__ == "__main__":
    ...
    variance_th = arguments["variance_threshold"]
    _save_path = (
            pathlib.Path(arguments["q_learning_models_dir"])
            / f"{model_name}"
            / f"NN_{train_data_name[:-7]}_{num_episodes}_{reward_type}_{pred_type}_{network_version}_{learning_rate}_{batch_size}_{buffer_size}_{epsilon_steps}_{variance_th}"
    )
