...
def parse_args(verbose: bool = False) -> typing.Dict[str, typing.Any]:
    ...
    parser.add_argument("--test_bank_name", default="x01_lower_triag_500_150_5_4.pickle")
    ...
    parser.add_argument("--target_update_freq", type=float, default=20)
    ...
    parser.add_argument("--epsilon_start", type=float, default=0.015)
    ...
    parser.add_argument("--max_item_per_learner", type=int, default=60)
    ...
    parser.add_argument("--model_name", type=str, default="online-Q-network-v4-5-factor-standarized-first3-triag")
...
if __name__ == "__main__":
    ...
    # retrain_params
    retrain_params ={
        "network_folder_dir" : "/home/jiguang0/bayesian-cat/models/q_learning/online-Q-network-v4-5-factor-standarized-first3-triag/NN_x01_lower_triag_500_150_5_4_150000_first3-0-1_detailed_v4_1.5e-05_128_30000_700000_0.16",
        "network_name": "fn_34000.pt",
